...
public class AbsActionBarActivity extends ActionBarActivity implements UitilityHelper, AppConstants{
	...
	public boolean isNetworkAvailable(Context context) {
		...
		boolean isNetworkAvailable = activityHimp.isNetworkAvailable(activity);

		if(!isNetworkAvailable) {
			showAlert(getString(R.string.network_error), getString(R.string.network_error_message), getString(R.string.ok), null,activity, null);
		}
